...
function FlowerPage(){
    ...
    return(
        ...
        <div className='fourthwest  mt-5'>
                <h2 className="container">Best Flower Garden in TamilNadu</h2>
            ...
            <div className='fourthwestmt-5'>
                <h2 className="container">Best Flower Garden in Kerala</h2>
                <div className='d-flex ms-3 justify-content-center row'>
                    <div className='foutheastimg col-12 col-md-4'>
            ...
            <div className='fourthwestmt-5'>
                <h2 className='container'>Best Flower Garden In Andhra</h2>
                <div className='d-flex ms-3 justify-content-center row'>
                    <div className='foutheastimg col-12 col-md-4'>
                        <div className="container d-flex justify-content-center align-items-center mt-2">
